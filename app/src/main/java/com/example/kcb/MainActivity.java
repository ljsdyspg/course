...
public class MainActivity extends AppCompatActivity {
    ...
    private void createcourseView(final Lesson lesson) {
        ...
        //获取课程开始的节数
        int class_start = Integer.valueOf(lesson.getBeginTime());
        //获取课程结束的节数
        int class_end= Integer.valueOf(lesson.getEndTime());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_about:
                Intent intent1 = new Intent(MainActivity.this, FillActivity.class);
